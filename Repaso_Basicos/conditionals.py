...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    :param generated_power: int or float - currently generated power
    :param percentage: int or float - reactor efficiency percentage
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if status < (threshold * 90)/100:
        return "LOW"
    elif abs(status - threshold) <= (threshold * 10) / 100:
        return "NORMAL"
    else:
        return "DANGER"
